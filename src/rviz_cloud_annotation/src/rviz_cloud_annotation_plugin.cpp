...
QRVizCloudAnnotation::QRVizCloudAnnotation(QWidget *parent) : rviz::Panel(parent), m_nh("~")
{
  ...
  */

  {
    ...
    // std::cout<<"param_string_previous:$$$$$$$$$$$$$$$$$$$$$$$$$$$$"<<param_string.c_str()<<std::endl;
...
void QRVizCloudAnnotation::onSetControlPointMaxWeight(const std_msgs::Int32 &msg)
{
  ...
  // showImageLabel("/home/igs/lidar_annotation/image/000001.jpg");
  // std::string file = m_image_files[FILE_ID];
  // showImageLabel(file.c_str());
}
...
//   // cv::Mat image = cv::imread(imagePath.c_str(), CV_LOAD_IMAGE_UNCHANGED);
//   if (image.empty())
//   {
